...
import cn.edu.zut.JLinux.Utils.MyFile;
import cn.edu.zut.JLinux.Utils.myRootDirectory;
import java.io.File;
    ...
    public Map<String, String> ls(Stack<MyFile> addressFile) {
        ...
        for (String s : myFileName) {
            ...
            String s1 = "name--" + tmpFile.getName() + "\tPermissions--" + tmpFile.getPermissions() + "\tPermissions1--"
                    ...
                    + "\tLastModifiedTime--" + tmpFile.getLastModifiedTime() + "\tsize--"
                    + tmpFile.getNextFilesToNextFilesName().size();
            outMap.put(s, s1);
        }
        return outMap;
    }
